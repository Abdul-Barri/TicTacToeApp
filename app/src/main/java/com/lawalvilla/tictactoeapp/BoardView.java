...
/**
 * Created by Abdul Barri on 4/9/2018.
 */
...
public class BoardView extends View {
    ...
    private MainAgainstComputer activity;
    ...
    public void setMainActivity (MainAgainstComputer a){
        activity = a;
    }
    ...
    private void drawGrid(Canvas canvas){
        for (int i = 0; i < 2; i++ ){
            ...
            canvas.drawRect(left2, right2, top2, bottom2, gridPaint);
        }
    }
